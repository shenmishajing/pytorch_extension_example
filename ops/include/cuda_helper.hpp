...
#define MAX_BLOCK_NUM 2147483647

inline std::size_t GET_BLOCKS(const std::size_t N, const int num_threads = THREADS_PER_BLOCK)
{
    std::size_t optimal_block_num = (N + num_threads - 1) / num_threads;
